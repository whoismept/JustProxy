...
import com.proxydegil.proxyapp.service.vpn.TcpConnectionManager
...
class ProxyVpnService : VpnService(), Runnable {
    ...
    private var proxyType: ProxyType = ProxyType.SOCKS5
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        proxyType      = ProxyType.valueOf(intent?.getStringExtra(EXTRA_PROXY_TYPE) ?: ProxyType.SOCKS5.name)
    ...
    private fun startForegroundNotification() {
        ...
        val notification = NotificationCompat.Builder(this, CHANNEL_ID)
            .setContentTitle("JustProxy VPN Aktif")
